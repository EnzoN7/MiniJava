...
public class MethodDeclaration implements ClassElement, Declaration {
    ...
    public MethodDeclaration(ClassAccessRight _accessRight, ElementModifier _state, Signature _signature, Block _body) {
    ...
    public MethodDeclaration(ElementModifier _state, Signature _signature, Block _body) {
        this.state = _state;
        this.signature = _signature;
        this.body = _body;
    }
