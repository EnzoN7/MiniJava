...
public interface Interface extends Declaration {
	 ...
	 * check that the declaration are allowed.
	 * 
	 ...
	 * and associate all identifiers uses with their definitions.
	 * 
	 ...
	 *         in the instruction have been previously defined.
	 */
	 ...
	 * in the instruction. Synthesized Semantics attribute that compute the size of
	 ...
	 * for the generated TAM code. Synthesized Semantics attribute that provide the
	 * generated TAM code.
	 * 
